...
async def whitehackrandomchar(ctx, character_name='Placeholder', race=False):
    ...
    embed.add_field(name="HP", value=random_char['HP'],inline=False)
    embed.add_field(name="AC", value=random_char['AC'],inline=False)
    embed.add_field(name="MV", value=random_char['MV'],inline=False)
    embed.add_field(name="AV", value=random_char['AV'],inline=False)    
